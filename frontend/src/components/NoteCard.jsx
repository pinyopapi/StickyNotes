...
import { pinNote, unpinNote, archiveNote, restoreNote, changeColor, addTag, removeTag } from '../services/noteService';
...
const NoteCard = ({ note, onUpdate }) => {
    ...
    return (
        <div className={`card m-2 ${note.isArchived ? 'bg-light text-muted' : ''}`} style={{ backgroundColor: color, width: '250px' }}>
